...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_theme_amber = QAction(MainWindow)
        self.action_theme_amber.setObjectName(u"action_theme_amber")
        self.action_theme_green = QAction(MainWindow)
        self.action_theme_green.setObjectName(u"action_theme_green")
        self.action_theme_purple = QAction(MainWindow)
        self.action_theme_purple.setObjectName(u"action_theme_purple")
        ...
        self.menu_theme.addAction(self.action_theme_amber)
        self.menu_theme.addAction(self.action_theme_green)
        self.menu_theme.addAction(self.action_theme_purple)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_theme_amber.setText(QCoreApplication.translate("MainWindow", u"\u7425\u73c0", None))
        self.action_theme_green.setText(QCoreApplication.translate("MainWindow", u"\u7eff\u8272", None))
        self.action_theme_purple.setText(QCoreApplication.translate("MainWindow", u"\u7d2b\u8272", None))
